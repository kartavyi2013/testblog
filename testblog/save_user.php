...
Администрация pntuc.com";//содержание сообщение
mail($email, $subject, $message, "Content-type:text/plane; Charset=utf-8\r\n");//отправляем сообщение
	
echo "<p class='margin_text'> Вам на E-mail відправлено лист з підтвердженням реєстрації. Увага! Посилання дійсне 1 годину. <a href='index.php'>Главная сторінка</a></p>"; //говорим о отправленном письме пользователю
}
